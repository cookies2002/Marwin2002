...
@app.on_message(filters.command(["gban", "globalban"]) & filters.create(owner_or_special_user))
@language
async def global_ban(client, message: Message, _):
    ...
    if user.id == message.from_user.id:
        ...
        return await message.reply_text("<b>‣ ʏᴏᴜ ᴄᴀɴ'ᴛ ɢʙᴀɴ ᴀ ᴡᴀʀʟᴏʀᴅ.</b>")
    ...
    await app.send_message(
        ...
        f"<b>• ᴡᴀʀʟᴏʀᴅs : {message.from_user.mention}</b>\n"
