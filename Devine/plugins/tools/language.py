...
@app.on_message(filters.command(["lang", "setlang", "language"]) & ~filter)
@language
async def lang_command(client, message: Message, _):
...
@app.on_callback_query(filters.regex("LG") & ~filter)
@languageCB
...
@app.on_callback_query(filters.regex(r"languages:(.*?)") & ~filter)
@ActualAdminCB
