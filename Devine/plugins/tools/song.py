...
from Devine import app, YouTube
...
from config import (filter, SONG_DOWNLOAD_DURATION,
                    SONG_DOWNLOAD_DURATION_LIMIT)
from Devine.utils.decorators.language import language, languageCB
from Devine.utils.formatters import convert_bytes
from Devine.utils.inline.song import song_markup
...
@app.on_callback_query(
    filters.regex(pattern=r"song_back") & ~filter
)
@languageCB
...
@app.on_callback_query(
    filters.regex(pattern=r"song_helper") & ~filter
)
@languageCB
...
@app.on_callback_query(
    filters.regex(pattern=r"song_download") & ~filter
)
@languageCB
