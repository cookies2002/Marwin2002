...
from config import filter as BANNED_USERS, SUPPORT_CHANNEL, SUPPORT_CHAT
...
async def awake(_, message: Message):
    ...
    if message.from_user.id == OWNER_ID:
        TEXT = "ɪ'ᴍ ᴀʟɪᴠᴇ ᴍʏ ʟᴏʀᴅ <a href='https://files.catbox.moe/bqv2ra.jpg' target='_blank'>💕</a> !\n\n"
    else:
        TEXT = f"ʏᴏᴏ {message.from_user.mention}, <a href='https://files.catbox.moe/bqv2ra.jpg' target='_blank'>💕</a>\n\nɪ'ᴍ {app.mention}\n──────────────────\n"
    ...
    [
        InlineKeyboardButton(text="ᴀᴅᴅ ɪɴ ɢʀᴏᴜᴘ", url="https://t.me/{boaxmusixbot}?startgroup=true"),
    ],
    ]    
