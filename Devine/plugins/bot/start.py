...
from config import filter as BANNED_USERS, OWNER_ID
...
async def start_pm(client, message: Message, _):
    ...
    started_msg = await message.reply_text(text="<b>sᴛᴀʀᴛᴇᴅ...<a href='https://files.catbox.moe/zv3jss.jpg' target='_blank'>ㅤ ㅤㅤㅤ</a></b>")
    ...
    if len(message.text.split()) > 1:
        ...
        if name.startswith("help"):
            ...
            await message.reply_text(
                text=(
                    f"<b>ʏᴏᴏ {message.from_user.mention}, <a href='https://files.catbox.moe/80y6ui.mp4' target='_blank'>💕</a></b>\n\n"
