...
@app.on_message(
    filters.command(["settings", "setting"]) & filters.group & ~filter
)
@language
...
@app.on_callback_query(filters.regex("settings_helper") & ~filter)
@languageCB
...
@app.on_callback_query(filters.regex("settingsback_helper") & ~filter)
@languageCB
...
@app.on_callback_query(filters.regex("FERRARIUDTI") & ~filter)
@ActualAdminCB
...
@app.on_callback_query(filters.regex(pattern=r"^(AUTH|AUTHLIST)$") & ~filter)
@ActualAdminCB
...
@app.on_callback_query(filters.regex("VOMODECHANGE") & ~filter)
@ActualAdminCB
