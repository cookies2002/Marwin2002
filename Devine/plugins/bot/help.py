...
from config import filter, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from Devine.utils.stuffs.buttons import BUTTONS
from Devine.utils.stuffs.helper import Helper

@app.on_message(filters.command(["help"]) & filters.private & ~filter)
@app.on_callback_query(filters.regex("settings_back_helper") & ~filter)
...
@app.on_message(filters.command(["help"]) & filters.group & ~filter)
@LanguageStart
...
@app.on_callback_query(filters.regex("help_callback") & ~filter)
@languageCB
...
@app.on_callback_query(filters.regex("mbot_cb") & ~filter)
